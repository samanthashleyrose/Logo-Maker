...
describe('Circle', () => {
    test('render() should return the correct circle SVG string', () => {
...
describe('Square', () => {
    test('render() should return the correct rect SVG string', () => {
...
describe('Triangle', () => {
    test('render() should return the correct polygon SVG string', () => {
